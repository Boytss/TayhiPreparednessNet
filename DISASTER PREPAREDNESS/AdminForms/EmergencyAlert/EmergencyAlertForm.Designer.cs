namespace DISASTER_PREPAREDNESS.AdminForms
{
    partial class EmergencyAlertForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            label3.Font = new Font("Sitka Heading", 24F, FontStyle.Regular, GraphicsUnit.Point);
            ...
            clearButton.BackgroundColor = Color.RoyalBlue;
            ...
            searchNameTextbox.BorderColor = Color.Black;
            searchNameTextbox.BorderFocusColor = Color.Blue;
            searchNameTextbox.BorderRadius = 15;
            searchNameTextbox.BorderSize = 1;
            searchNameTextbox.Font = new Font("Segoe UI", 11.25F, FontStyle.Regular, GraphicsUnit.Point);
            ...
            searchByPurokDropdown.Font = new Font("Segoe UI", 11.25F, FontStyle.Regular, GraphicsUnit.Point);
            ...
            txtPort.Font = new Font("Segoe UI", 11.25F, FontStyle.Regular, GraphicsUnit.Point);
            txtPort.ForeColor = Color.Black;
            txtPort.IconColor = Color.MediumSlateBlue;
            txtPort.Items.AddRange(new object[] { "COM5", "COM10", "COM6" });
            ...
            message.Font = new Font("Segoe UI", 11.25F, FontStyle.Regular, GraphicsUnit.Point);
